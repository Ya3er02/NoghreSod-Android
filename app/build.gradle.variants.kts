...
android {
    ...
    buildTypes {
        debug {
            ...
            buildConfigField("String", "API_BASE_URL", "\"${localProperties.getProperty("dev.api.url", "https://dev-api.noghresod.com/api/v1/")}\"")
            buildConfigField("long", "API_TIMEOUT", "${localProperties.getProperty("dev.api.timeout", "30")}L")
        ...
        release {
            ...
            buildConfigField("String", "API_BASE_URL", "\"${localProperties.getProperty("prod.api.url", "https://api.noghresod.com/api/v1/")}\"")
            buildConfigField("long", "API_TIMEOUT", "${localProperties.getProperty("prod.api.timeout", "30")}L")
            buildConfigField("boolean", "ENABLE_LOGGING", "false")
        ...
        create("staging") {
            ...
            buildConfigField("String", "API_BASE_URL", "\"${localProperties.getProperty("staging.api.url", "https://staging-api.noghresod.com/api/v1/")}\"")
            buildConfigField("long", "API_TIMEOUT", "${localProperties.getProperty("staging.api.timeout", "30")}L")
            buildConfigField("boolean", "ENABLE_LOGGING", "true")
